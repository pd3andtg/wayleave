...
<body style="font-family:'Poppins',sans-serif; background:#f4f6fb; display:flex; align-items:center; justify-content:center; min-height:100vh; margin:0;">
  <div style="text-align:center; padding:2rem;">
    ...
    <h1 style="font-size:5rem; font-weight:700; color:#07326A; margin:0; line-height:1;">404</h1>
    <h2 style="font-size:1.25rem; font-weight:600; color:#333; margin:0.5rem 0 1rem;">Page Not Found</h2>
    <p style="color:#6c757d; margin-bottom:2rem;">The page you are looking for does not exist or has been moved.</p>
